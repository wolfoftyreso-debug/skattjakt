...
fn route_label(path: &str) -> &'static str {
    ...
    match (
        ...
        (Some("v1"), Some("documents"), Some("tickets"), None) => "/v1/documents/tickets",
        (Some("v1"), Some("documents"), Some("tickets"), Some(_)) => "/v1/documents/tickets/{id}",
        (Some("v1"), Some("notifications"), None, _) => "/v1/notifications",
        (Some("v1"), Some("users"), None, _) => "/v1/users",
        (Some("v1"), Some("auth"), Some("devices"), _) => "/v1/auth/devices",
        (Some("v1"), Some("auth"), Some(_), None) => "/v1/auth/{action}",
